...
const TransactionHistory = () => {
  ...
  // Mock data structure based on the image requirements
        ...
        <table className="w-full">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th 
                className="px-4 py-3 text-left text-sm font-medium text-gray-700 cursor-pointer hover:bg-gray-200 bg-blue-100"
